...
/**
 * Created by brandon3055 on 04/06/2025
 */
public class BCStreamCodec {

    public static <T> StreamCodec<ByteBuf, TagKey<T>> tagKeyCodec(ResourceKey<? extends Registry<T>> resourceKey) {
    ...
    public static <B, C, T1, T2, T3, T4> StreamCodec<B, C> composite(
            ...
            final Function4<T1, T2, T3, T4, C> p_331335_) {
        return new StreamCodec<>() {
            @Override
            public C decode(B p_330310_) {
                T1 t1 = codec1.decode(p_330310_);
                ...
                return p_331335_.apply(t1, t2, t3, t4);
            }
    ...
    public static <B, C, T1, T2, T3, T4, T5> StreamCodec<B, C> composite(
            ...
            final Function5<T1, T2, T3, T4, T5, C> p_331335_) {
        return new StreamCodec<>() {
            @Override
            public C decode(B p_330310_) {
                T1 t1 = codec1.decode(p_330310_);
                ...
                return p_331335_.apply(t1, t2, t3, t4, t5);
            }
